        ...
        <div className='flex items-center gap-4'>
...

          {
            ...
            : <div className='flex items-center gap-3'>
                ...
                <button onClick={() => navigate('/register')} className='bg-linear-to-r from-blue-600 to-blue-400 text-white px-6 py-2.5 rounded-full font-semibold hidden md:block hover:shadow-lg transition-all duration-300'>Create Account</button>
              </div>
          }
        </div>
            ...
            {!token && (
              <>
                ...
                <button 
                  ...
                  className='bg-linear-to-r from-blue-600 to-blue-400 text-white px-6 py-2.5 rounded-full font-semibold hover:shadow-lg transition-all duration-300 w-full'>
                  Create Account
                </button>
              </>
            )}
